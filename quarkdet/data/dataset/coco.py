...
class CocoDataset(BaseDataset):
    ...
    def get_data_info(self, ann_path):
        ...
        self.img_ids = sorted(self.coco_api.imgs.keys())  # image의 id들을 저장
    ...
    def get_img_annotation(self, idx):
        ...
        for ann in anns:
            ...
            if ann['area'] <= 0 or w < 1 or h < 1:  # 매우 작으면 넘어간다는 뜻
                continue
            ...
            # iscrowd가 0이면 segmentation이 polygon base, 1이면 uncompressed RLE base
            if ann['iscrowd']:
